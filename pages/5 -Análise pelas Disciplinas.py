...
disciplinas_disponiveis = ['PROGRAMACAO IMPERATIVA','FISICA 1','FISICA 2','FISICA 3','FISICA E SOCIEDADE','FISICA MATEMATICA 1','FISICA MATEMATICA 2','LABORATORIO DE FISICA 1','PERSPECTIVAS EM ASTROFISICA','INTRODUCAO A ASTRONOMIA E ASTROFISICA','SISTEMAS PLANETÁRIOS','MÉTODOS EM ASTROFÍSICA OBSERVACIONAL','ASTROFÍSICA ESTELAR','LABORATÓRIO DE ASTRONOMIA E ASTROFÍSICA','ASTROFÍSICA GALÁCTICA','ASTROFÍSICA EXTRAGALÁCTICA','INTRODUÇÃO A COSMOLOGIA','CALCULO NUMERICO','VETORES E GEOMETRIA ANALITICA','CALCULO A','CALCULO B','CALCULO C','CALCULO D','EQUACOES DIFERENCIAIS I','QUIMICA I']
